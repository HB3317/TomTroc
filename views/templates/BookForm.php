...
<div class="book-form-view">
    ...
    <form
        action="index.php?action=<?= $isEdit ? 'editBook&id=' . $book->getId() : 'addBook'; ?>"
        method="post"
    ...
    >
        <div class="image">
            ...
            <img
                id="book-preview"
                src="<?= $isEdit ? htmlspecialchars($book->getImage()) : './assets/images/books/default_book_image.jpg'; ?>"
                alt="Image du livre"
            >
        ...
        <div class="form">
            <div class="form-grid">
                ...
                <input 
                    ...
                    name="title"
                    id="title"
                    value="<?= $isEdit ? htmlspecialchars($book->getTitle()) : ''; ?>" required
                >
                ...
                <input
                    ...
                    name="author"
                    id="author"
                    value="<?= $isEdit ? htmlspecialchars($book->getAuthor()) : ''; ?>" 
                    required
                >
                ...
                >
                    <?= $isEdit ? htmlspecialchars($book->getDescription()) : ''; ?>
                </textarea>
