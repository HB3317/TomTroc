<div class="my-account-view">
    ...
    <div class="user-info">
        <div class="infos">
            <div class="image-info">
                <img
                    class = "user-image"
                    src="./assets/images/users/<?= htmlspecialchars($user->getId()); ?>.jpg?v="
                    alt="Photo de profil"
                >
                ...
                <?php foreach ($userBooks as $book) { ?>
                    <tr>
                        ...
                        <td>
                            <a
                                class="edit-book-btn"
                                href="index.php?action=editBookForm&id=<?= $book->getId(); ?>"
                            >
                            Éditer
                            </a>
                            <a
    ...
    <div class="modal hidden" id="change-image-modal">
        <div class="modal-content">
            ...
            <form
                class="modal-form"
                action="index.php?action=changeUserImage"
                method="post"
